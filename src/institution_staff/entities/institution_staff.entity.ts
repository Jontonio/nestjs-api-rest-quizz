...
export class InstitutionStaff {
  ...
  @ManyToOne(() => Staff, (ts: Staff) => ts.institutionstaffs, {
    nullable: false,
    onUpdate: "CASCADE",
  })
  ...
  @ManyToOne(() => Institution, (ie: Institution) => ie.institution_staffs, {
    nullable: false,
    onUpdate: "CASCADE",
  })
  @JoinColumn({
    name: "cod_mod_institution",
    referencedColumnName: "cod_mod_institution",
  })
