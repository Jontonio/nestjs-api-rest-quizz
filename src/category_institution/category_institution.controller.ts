...
export class CategoryInstitutionController {
  constructor(
    private readonly categoryInstitutionService: CategoryInstitutionService,
  ) {}
  ...
  update(
    @Param("id") id: string,
    @Body() updateCategoryInstitutionDto: UpdateCategoryInstitutionDto,
  ) {
    return this.categoryInstitutionService.update(
      +id,
      updateCategoryInstitutionDto,
    );
  }
